...
### Dependencies
- Bump `brace-expansion` (transitive) from 5.0.6 to 5.0.9 in `backend`, and from 5.0.8 to 5.0.9 in `frontend` ([#PLACEHOLDER](https://github.com/isolinear-labs/Neosynth/pull/PLACEHOLDER))
- Bump `brace-expansion` (transitive) from 2.1.1 to 2.1.4 and from 1.1.15 to 1.1.18 in `backend` ([#PLACEHOLDER](https://github.com/isolinear-labs/Neosynth/pull/PLACEHOLDER))
- Bump `ip-address` (transitive, via `speakeasy`) from 10.2.0 to 10.4.0 in `backend` ([#PLACEHOLDER](https://github.com/isolinear-labs/Neosynth/pull/PLACEHOLDER))
- Bump `js-yaml` from 4.3.0 to 4.3.1 ([#PLACEHOLDER](https://github.com/isolinear-labs/Neosynth/pull/PLACEHOLDER))
